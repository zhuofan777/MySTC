...
def run(dts, alpp, bltt, yltt):
    # target_train 为标签 data_train 为序列
    data_train, data_test, target_train, target_test, nclass = load_raw_ts("D://tmppro//data//", dts)
...
alpp = [0.3, 0.4, 0.5, 0.6]
bltt = [50, 60, 70, 80, 90, 100]
yltt = [3, 4, 5, 6, 7, 8]
k = [50, 100, 150]
for dst in dataset:
    for alp in alpp:
